...
public class TransferTest {
    ...
    public void threeAttributesConstructorTest() {
        assertEquals("03.03.2000", incomingTransfer.get_date());
    ...
    public void allAttributesConstructorTest() {
        assertEquals("30.07.2020", outgoingTransfer.get_date());
    ...
    public void copyConstructorTester() {
        ...
        assertEquals(outgoingTransfer.get_date(), copyTransfer.get_date());
