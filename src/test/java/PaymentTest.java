...
public class PaymentTest {
    ...
    public void threeAttributesConstructorTest() {
        assertEquals("12.03.2008", payment1.get_date());
    ...
    public void allAttributesConstructorTest() {
        assertEquals("23.09.1897", payment2.get_date());
        ...
        assertEquals(0.5, payment2.getOutcomingInterest());
    }

    @Test
    public void copyConstructorTest() {
        assertEquals(payment2.get_date(), copyPayment.get_date());
        ...
        assertEquals(payment2.getOutcomingInterest(), copyPayment.getOutcomingInterest());
    }
    ...
    public void calculateOutgoingInterestTest() {
        double expected = payment2.getAmount() + payment2.getOutcomingInterest() * payment2.getAmount();
